...
maindir="$($bb dirname "$@")"
echo "masuk $maindir"
echo "oat2dex for under 24 sdk"
##########
/data/data/per.pqy.apktool/apktool/openjdk/bin/java -Xmx1024m -jar $raj/oat2dex-0.88.jar -o $maindir/d-eodex boot /system/framework/arm
cd $maindir
$bb mv ./de-odex/*.dex ../
